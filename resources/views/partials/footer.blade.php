        ...
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full sm:w-1/6 px-4 mb-8">
                ...
                <ul>
                    ...
                    <li class="flex items-center mb-2">
                        <img src="{{ asset('/assets/images/social_icons/pinterest.svg') }}" alt="Instagram"
                            class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
                        <a href="#" class="hover:text-primary">Pinterest</a>
                    </li>
                    <li class="flex items-center mb-2">
                        <img src="{{ asset('/assets/images/social_icons/youtube.svg') }}" alt="Instagram"
                            class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
    ...
    <div class="py-6 border-t border-gray-line">
        <div class="container mx-auto px-4 flex flex-wrap justify-between items-center">
            ...
            <div class="w-full lg:w-1/4 text-center lg:text-right">
                <img src="{{ asset('/assets/images/social_icons/paypal.svg') }}" alt="PayPal"
                    class="inline-block h-8 mr-2">
                <img src="{{ asset('/assets/images/social_icons/stripe.svg') }}" alt="Stripe"
                    class="inline-block h-8 mr-2">
