...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('assets/build/assets/img/favicon.png') }}" />
    <title>Toko Onlineku | Dashboard</title>
...
<!-- plugin for charts  -->
<script src="{{ asset('assets/build/assets/js/plugins/chartjs.min.js') }}" async></script>
<!-- plugin for scrollbar  -->
<script src="{{ asset('assets/build/assets/js/plugins/perfect-scrollbar.min.js') }}" async></script>
<!-- github button -->
<script async defer src="https://buttons.github.io/buttons.js"></script>
<!-- main script file  -->
<script src="{{ asset('assets/build/assets/js/soft-ui-dashboard-tailwind.js') }}" async></script>
